  ...
  storyBank: [
    {
      ...
      talkTrack: "When I took over the Collibra governance program at Pfizer, adoption had stalled — roughly 600 users across 7 business units, and leadership was questioning the ROI. Several BU heads, including key stakeholders in R&D and commercial data, were actively resistant. There was no mandate from above and no additional headcount, so I needed a grassroots strategy.\n\nI identified 3 champion users in high-visibility teams — including the GPD-IP domain in R&D, which handles clinical trial, regulatory, and safety data. I worked with each champion to build 'quick win' governance workflows that saved their teams measurable time. One specific example: we built a custom approval workflow in Collibra for tracking changes to business standard definitions. That gave stewards full traceability — they could see the complete history of any term's definition without filing formal requests. I took those wins on an executive roadshow to build momentum across other BUs. I also redesigned onboarding entirely — replaced a 2-hour passive lecture with a 20-minute hands-on lab where participants left with governance assets actually configured. And I launched a 'Data Governance Office Hours' Slack channel for ongoing support.\n\nThe result was 40% adoption growth year-over-year — from roughly 600 to over 1,000 users across 10+ business units. Three BU heads who had been resistant became vocal advocates. The Slack channel averaged 15+ questions per week and became the model for other platform teams. Pfizer's implementation was featured as a case study at Collibra's Data Citizens '24 conference, with my director and Deloitte presenting our enterprise-wide data excellence strategy.",
    },
    {
      id: "story_seed_2",
      ...
      talkTrack: "Pfizer had a split-platform situation — most of the enterprise was on Collibra, but several business units including the GPD-IP R&D domain were on Alation for data cataloging. That created metadata silos, duplicated governance effort, and pushed licensing costs past $2M annually. Leadership asked me to lead the evaluation: consolidate on Collibra, consolidate on Alation, or maintain both.\n\nI partnered with Divye Goel, who managed the GPD-IP domain, and we structured the evaluation around workflows our teams actually used — not vendor feature checklists. We tested both platforms on four criteria: data lineage depth and visualization — could it trace a clinical data field from source to report? UI accessibility for non-technical business stewards. Mass upload/download for bulk metadata operations, which R&D teams ran frequently during domain migrations. And total cost of ownership. Collibra won decisively on all four — deeper lineage visualization, a more intuitive UI, mass operations that matched how our stewards actually worked, and lower long-term TCO.\n\nOnce the decision was made, I mapped every Alation asset type to its Collibra equivalent — catalog assets, glossary terms, lineage relationships — and built a parallel-run period so both systems stayed synchronized during the transition. I created domain-specific migration guides and held weekly office hours with each team's stewards for three months, resolving concerns as they came up.\n\nWe completed the migration with zero downtime and zero data loss. The GPD-IP domain is now fully on Collibra with its complete hierarchy — Rulebooks, Codelists, Logical and Physical Data Dictionaries, Glossary, and Technology Asset Domain — all governed under a 5-role stewardship model. Post-migration satisfaction was 85% positive. Licensing consolidation drove a 50% cost reduction. Divye has confirmed all outcomes in writing and offered to serve as a reference.",
    },
    {
      id: "story_seed_3",
      ...
      talkTrack: "The GPD-IP domain at Pfizer handled some of the most sensitive data in the company — clinical trial data, regulatory submissions, and safety data within R&D. It had zero formal governance in Collibra. No asset taxonomy, no stewardship model, no approval workflows. Metadata changes were informal and untraceable, which created audit risk and made it impossible to demonstrate data lineage to regulators.\n\nI worked with Divye Goel and the domain team to design the complete governance architecture. We built a full domain hierarchy in Collibra: Rulebooks to codify business rules, Codelists for controlled vocabularies, a Logical Data Dictionary for business definitions, a Physical Data Dictionary for technical metadata, a Technology Asset Domain for systems and integrations, and a shared Glossary. I also mapped Physical-to-Logical Data Dictionary relationships so business definitions linked directly to their technical implementations. Then I configured a 5-role stewardship model — Business Owner, Community Manager, Reviewer, Subject Matter Expert, and Technical Steward — with inherited permissions so responsibilities cascaded through the hierarchy.\n\nThe most impactful piece was a custom approval workflow for changes to business standard definitions. Any proposed change by an SME triggered a review chain, created a full audit trail, and let business users see the complete history of how a standard had evolved over time.\n\nThe domain went from zero governance to a fully architected, audit-ready Collibra implementation. The audit trail became a key compliance tool for regulatory submissions, and the architecture became the reference model we used for every subsequent domain onboarding at Pfizer.",
    },
    {
      id: "story_seed_4",
      ...
      talkTrack: "The metadata governance review cycle at Pfizer was averaging 14 business days from submission to approval. That bottleneck frustrated data producers and delayed time-to-insight for analytics teams. It was especially painful for high-velocity domains like R&D, where data standards changed frequently and delays held up downstream work. The root cause was manual processes: approvals routed by email, SMEs chased individually for sign-off, and zero visibility into where any request sat in the queue.\n\nI analyzed six months of governance requests and found that 60% of the delay was concentrated in manual routing and approval queues. So I redesigned the Collibra stewardship workflows to auto-route based on metadata domain and asset type, leveraging the 5-role model I'd already configured for GPD-IP. I added a tiered review system: low-risk changes to Codelists and Glossary terms were auto-approved with notifications, while changes to Rulebooks, Logical Data Dictionary definitions, and Physical Data Dictionary mappings required human review. I also replaced the ad-hoc email chains with a single daily digest notification for each SME.\n\nWe cut the average cycle time from 14 to under 10 business days — a 30% reduction. Auto-approval handled 40% of routine changes, freeing Technical Stewards and Subject Matter Experts to focus on complex governance decisions. Audit compliance remained at 100% throughout. The Deloitte team referenced this workflow design at Pfizer's Data Citizens '24 conference presentation as an example of governance operating at scale.",
    },
    {
      id: "story_seed_5",
      ...
      talkTrack: "In 2024, Pfizer's data leadership needed to make a definitive platform decision. Annual governance tooling spend exceeded $2M, split between Collibra and Alation. The R&D teams on Alation — particularly the GPD-IP domain — had years of institutional comfort with the tool and were skeptical of any migration. This was a politically sensitive evaluation with direct budget and operational consequences.\n\nI partnered with Divye Goel, who led the GPD-IP domain, and we structured the evaluation around workflows our teams used daily — not vendor feature checklists or analyst reports. We tested against four criteria, each chosen because it mapped to how our stewards actually worked: data lineage depth — could the platform trace a clinical data field from source system through transformations to a report? UI accessibility — could non-technical business SMEs manage definitions without IT support? Mass upload/download — could R&D teams run bulk metadata operations during domain migrations? And total cost of ownership including licensing, implementation, and ongoing maintenance.\n\nI built a feature-mapping matrix showing which Alation capabilities Collibra could absorb and which would require new workflows. That made the recommendation defensible — it was grounded in evidence from our specific use cases, not opinion.\n\nCollibra won on all four criteria: significantly deeper lineage visualization, a more intuitive UI that business SMEs could navigate without training, mass operations that matched R&D's bulk workflows, and a lower long-term TCO once migration costs were amortized. Leadership accepted the recommendation. The migration was executed in 2025, resulting in a 50% licensing cost reduction. Divye confirmed the assessment outcomes and has offered to serve as a reference.",
    },
    {
      id: "story_seed_6",
      title: "About Me — Career Arc & CE Bridge",
      themes: ["About Me", "Career Arc", "CE Bridge"],
      situation: "My degree is in Management Information Systems — a broad degree by design, and that breadth shaped my career. I've spent 10 years at Pfizer doing operations work across three distinct domains: finance, digital automation, and data enablement. Each role was different, but the through line was always the same — using analytical skills and the right tools to improve how teams operated.",
      ...
      action: "I started in finance on the decision support side — using data to help finance leaders make better decisions. From there I moved into a digital automation team doing RPA, and eventually landed in data enablement, specifically working on Collibra implementations across 10+ business units. At each step, the pattern was the same: find the right tool for the problem, set it up properly, and make sure the people using it could get sustained value from it. The Collibra work showed me how central data trust is becoming — especially as organizations start feeding data into AI. If the data isn't governed and certified, you can't trust what the AI gives back. I saw that firsthand.",
      result: "10 years at Pfizer spanning three distinct operational domains, culminating in leading one of the largest single-enterprise Collibra deployments (10+ BUs, 1,000+ users, 40% adoption growth, 50% licensing cost reduction). Now transitioning to take that implementation experience to the customer side — helping organizations get there faster than we did. The CE role at Collibra is the natural next step: doing at scale, for the company that built the product, what I did internally for one of their biggest customers.",
      talkTrack: "My degree is in Management Information Systems — a broad degree by design, and that breadth is what shaped my career. It opened doors across multiple business functions, and I've spent most of that career at Pfizer, doing operations work across three distinct domains.\n\nI started in finance on the decision support side — using data to help finance leaders make better decisions. From there I moved into a digital automation team doing RPA, and eventually landed in data enablement, specifically leading Collibra implementations across 10+ business units and over 1,000 users. Different departments, but the through line was always the same: find the right tool, configure it for the context, and make sure the people depending on it could use it without friction.\n\nWhat the Collibra work showed me was how central data trust is becoming — especially as organizations start feeding data into AI. If the data isn't governed and certified, you can't trust what the AI gives back. I saw that firsthand at Pfizer. And what I want to do now is take that implementation experience and bring it to the customer side — helping organizations get there faster than we did.",
    },
  ],
}
...
export const collibraCompany = {
  name: "Collibra",
  companyProfile: {
    summary: "Collibra is a late-stage private SaaS unicorn (valued at $5.25B as of Series G) that builds the leading enterprise platform for data and AI governance. Founded in December 2008 in Brussels by Felix Van de Maele, Stijn Christiaens, Damien Trog, and Pieter De Leenheer (based on semantic web research at VU Brussels), they now serve 700+ enterprise customers globally — including 100+ Fortune 500 companies like Toyota, Heineken, BNY Mellon, Siemens, McDonald's, and Pfizer — from dual headquarters in New York and Brussels. Approximately 1,000–1,100 employees (1,083 per RepVue, March 2026). Total funding: $596M across 9 rounds (Series A in 2012 through Series G at $250M in Nov 2021). Key investors: Sequoia Capital Global Equities, Sofina, CapitalG (Alphabet), ICONIQ, Tiger Global. Forbes Cloud 100 (2025). Customers report significant ROI per Forrester TEI study (vendor-commissioned).",
    mission: "Collibra's formal mission (updated April 2025) is 'Empowering Data Citizens to take command of data and AI, transforming possibilities into progress.' The tagline 'Data Confidence™' remains prominent across marketing. They position themselves as the leader in unified governance for data and AI, making trusted, AI-ready data accessible to all 'Data Citizens' across an organization. The strategic pivot since 2024 has been from 'data governance vendor' to 'unified governance platform for data AND AI' — covering structured data, unstructured data, and AI model governance under one roof.",
    productsServices: "The Collibra Platform (built on a semantic graph architecture) includes 8 named products plus recently acquired capabilities: Data Governance (Business Glossary, Policy Manager, Stewardship, Workflow Designer), Data Catalog (metadata harvesting, profiling, classification, AI Copilot), Data Lineage (end-to-end technical and business lineage, supports OpenLineage), Data Quality & Observability (automated rule creation, anomaly detection), Data Privacy (GDPR/CCPA compliance, RoPA, PII discovery, DSAR workflows), AI Governance (model/agent registries, risk assessments, EU AI Act Assessment Tool — core GA Feb 2024, EU AI Act tooling added Jan 2025), Data Marketplace (consumer portal for data product discovery), plus Unstructured AI (via Deasy Labs acquisition July 2025, GA Oct 2025 — discovers and enriches PDFs, transcripts, emails for GenAI workflows) and Data Access Governance (via Raito acquisition June 2025 — integration forthcoming). Also: Collibra Everywhere browser extension, Collibra Edge agent for hybrid deployment. 100+ native integrations with Databricks, Snowflake, BigQuery, SAP, Azure, Tableau, Salesforce, dbt, Airflow, and more. Enterprise pricing: base starts ~$170K/year, typical deals range $500K–$2M+ annually.",
    culture: "Collibra brands itself around the 'Data Citizen' concept — democratizing data access for everyone. They received Great Place to Work certification in 2022 (96% positive across Belgium, Poland, UK, US). Glassdoor reviews (3.3/5 stars, 519 reviews) highlight smart colleagues, a strong product, and decent compensation as positives. However, a layoff of ~100 employees in October 2022 and subsequent understaffing have impacted the culture — recent reviews cite 'badly understaffed,' management friction, and multiple restructurings. April 2025 cultural framework reset introduced four values: 'Our customers are our true north,' 'We show up and win,' 'We are respectfully direct,' and 'We are One Collibra.' The company is transitioning from hypergrowth mode to efficient, execution-focused growth. Typical of late-stage unicorns pushing toward profitability.",
    keyFacts: [
      "Named Leader in the Gartner Magic Quadrant for Data & Analytics Governance Platforms in both the inaugural 2025 and 2026 reports. Note: Atlan also achieved Leader status in 2026, so Collibra is not the sole Leader",
      "Total funding: $596M across 9 rounds. Investors include Sequoia Capital Global Equities, Sofina, CapitalG (Alphabet), ICONIQ, Tiger Global. Reached unicorn status in Jan 2019 (Series E, $100M, first Belgian unicorn)",
      "Data governance market sized at $4.0B–$5.4B (2025), growing at 16–20% CAGR to ~$16B by 2032. Collibra is positioned to capture significant share as AI governance demand accelerates",
      ...
      "Launched MCP Server (GA Nov 2025) — lets AI agents (Claude, ChatGPT) access governed metadata via Model Context Protocol. Also in preview: Data Contracts (Oct 2025), Semantic Mapping (Nov 2025), Data Recommender (Nov 2025) — none GA yet as of early 2026",
      ...
      "Named Google Cloud Data & Analytics Partner of the Year for Governance (2025, third consecutive year) and Partner of the Year by both Databricks and Snowflake (2024). Key GSI partners: Deloitte (Global SI of the Year 2025), Accenture (Customer Impact & Innovation Partner), PwC (Rising Star Partner)",
      "Key verticals: financial services (strongest), healthcare, retail/CPG, energy, government. Forrester TEI study (vendor-commissioned) reports significant ROI — cite as 'according to a Forrester study' without specific figures unless you can verify them",
    ],
    interviewTips: [
      ...
      "Use the phrase 'Data Citizens' naturally in conversation — it's core to Collibra's identity. Know the updated mission ('Empowering Data Citizens to take command of data and AI') and the four values, especially 'We are respectfully direct.' Reference Heineken's 'Common Business Language' across 80 countries and 85,000 employees as a customer success example",
      "In the Partner/AVP round, emphasize the GSI ecosystem (Deloitte as Global SI of the Year, Accenture, PwC) — Collibra's $500K–$2M+ deals are rarely closed without partner involvement. Show you understand enterprise deal mechanics",
      "Know the customer success stories: Heineken unified data across 80 countries with a Common Business Language. McDonald's did a 60-day Rapid Start deployment across 95 markets including AI governance for connected kitchens. Reference the Forrester TEI study for ROI but don't cite specific dollar figures unless you can verify them from the published report",
    ],
  },
}
...
export const collibraRole = {
  ...
  interviewNarratives: {
    aboutMe: {
      version: "V5 — Current Best (75 seconds spoken)",
      text: "My degree is in Management Information Systems — a broad degree by design, and that breadth is what shaped my career. It opened doors across multiple business functions, and I've spent most of that career at Pfizer, doing operations work across three distinct domains.\n\nI started in finance on the decision support side — using data to help finance leaders make better decisions. From there I moved into a digital automation team doing RPA, and eventually landed in data enablement, specifically leading Collibra implementations across 10+ business units and over 1,000 users. Different departments, but the through line was always the same: find the right tool, configure it for the context, and make sure the people depending on it could use it without friction.\n\nWhat the Collibra work showed me was how central data trust is becoming — especially as organizations start feeding data into AI. If the data isn't governed and certified, you can't trust what the AI gives back. I saw that firsthand at Pfizer. And what I want to do now is take that implementation experience and bring it to the customer side — helping organizations get there faster than we did.",
      notes: "Opens with MIS degree as narrative setup — explains how you ended up across departments without sounding scattered. 'Three distinct domains' is more precise than 'multiple departments.' Adds specific scale numbers (10+ BUs, 1,000+ users). AI angle woven into close. Ends with strong CE bridge.",
    },
    fullStory: {
  ...
  demoPrep: {
    ...
    referenceMaterials: [
      ...
      },
      {
        ...
        url: "https://www.youtube.com/@CollibraInc",
      },
      {
        ...
        days: [
          ...
          },
          {
            ...
            tasks: [
              ...
              {
                label: "Hour 2",
                text: "Watch one Collibra product demo on YouTube (youtube.com/@CollibraInc). Study the narrative structure: problem → capability → outcome. Note how they transition from business pain to product screen. You need to internalize this flow — Ralf will expect you to talk about the platform like a CE, not an end user.",
              },
            ],
          },
          {
  ...
  learningGuide: [
    ...
    },
    {
      ...
      items: [
        ...
        "Watch the YouTube Product Demos playlist (youtube.com/@CollibraInc) — 18 videos (some may be unavailable), updated Feb 2026. Shows the actual UI for glossary creation, lineage visualization, data profiling, and quality rules. Study the narrative structure: how Collibra's own team leads with the business problem, not the feature. This is the fastest way to build visual familiarity with screens you haven't used",
        ...
        "Know the Ranger certification system — the Ranger cert requires the Solution Architect certification first, then a single project-based exam where you configure a complete Collibra environment from a scenario brief within a 1-month window (approximately 40-60 hours of effort). It's the most rigorous Collibra certification available. Mentioning that you'd pursue Ranger certification after joining shows commitment to deep product mastery",
      ],
    },
  ],
