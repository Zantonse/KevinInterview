  ...
  storyBank: [
    {
      ...
      talkTrack: "When I took over the Collibra governance program at Pfizer, adoption had stalled — about 600 users across 7 business units, and leadership was questioning the ROI. Several BU heads were actively resistant to adopting the platform. There was no mandate from above and no extra headcount, so I needed a grassroots strategy.\n\nI started by finding 3 champion users in high-visibility teams — including the GPD-IP domain in R&D, which handles clinical and regulatory data. I worked with each champion to build 'quick win' governance workflows that saved their teams real time. One example: we built a custom approval workflow in Collibra for tracking changes to business standard definitions, so stewards could see the full history of any term without filing a formal request. I took those wins on an executive roadshow to build momentum. I also completely redesigned onboarding — turned a 2-hour lecture into a 20-minute hands-on lab where people left with actual governance assets configured. And I launched a Slack channel for real-time governance help.\n\nThe result was 40% adoption growth year-over-year — from 600 to over 1,000 users across 10+ business units. Three BU heads who had been resistant became vocal advocates. The Slack channel averaged 15+ questions per week. And Pfizer's implementation ended up being featured as a case study at Collibra's Data Citizens '24 conference.",
    },
    {
      id: "story_seed_2",
      ...
      talkTrack: "Pfizer had a split-platform situation — most of the enterprise was on Collibra, but several business units including the R&D domain were on Alation. That created metadata silos, duplicated governance effort, and inflated licensing costs past $2M annually. Leadership asked me to lead the evaluation: consolidate on Collibra, consolidate on Alation, or keep both.\n\nI partnered with Divye Goel, who ran the R&D domain, and we structured the evaluation around actual workflows — not feature checklists. We tested both platforms on four criteria that mattered to our users: lineage depth, UI accessibility for non-technical stewards, mass metadata operations for bulk work, and total cost of ownership. Collibra won on all four.\n\nOnce the decision was made, I mapped every Alation asset to its Collibra equivalent, built a parallel-run period so both systems stayed in sync during the transition, created domain-specific migration guides, and held weekly office hours with each team's stewards for three months.\n\nWe completed the migration with zero downtime and zero data loss. Post-migration satisfaction was 85% positive, and the licensing consolidation drove a 50% cost reduction. Divye has offered to be a reference and confirmed the outcomes in writing.",
    },
    {
      id: "story_seed_3",
      ...
      talkTrack: "The GPD-IP domain at Pfizer handled some of the most sensitive data in the company — clinical trials, regulatory submissions, safety data. And it had zero formal governance in Collibra. No asset taxonomy, no stewardship model, no approval workflows. Any metadata change was informal and untraceable, which was a real audit risk.\n\nI worked with Divye Goel and the domain team to design the full governance architecture from scratch. We built out a complete domain hierarchy in Collibra: Rulebooks for business rules, Codelists for controlled vocabularies, Logical and Physical Data Dictionaries, a Technology Asset Domain, and a shared Glossary. Then I configured a 5-role stewardship model — Business Owner, Community Manager, Reviewer, SME, and Technical Steward — with inherited permissions so responsibilities cascaded through the hierarchy.\n\nThe most impactful piece was a custom approval workflow for changes to business standard definitions. Any proposed change by an SME triggered a review chain, created an audit trail, and let business users see the full history of how a standard had evolved over time.\n\nThe domain went from zero governance to a fully architected Collibra implementation. The audit trail became a key compliance tool, and the architecture became the reference model we used for every subsequent domain onboarding at Pfizer.",
    },
    {
      id: "story_seed_4",
      ...
      talkTrack: "Our metadata governance review cycle at Pfizer was averaging 14 business days from submission to approval. That was a real bottleneck — data producers were frustrated, analytics teams were waiting for data they couldn't use yet. The root cause was mostly manual: approvals were routed by email, SMEs had to be chased for sign-off, and nobody could see where a request was in the queue.\n\nI analyzed six months of governance requests and found that 60% of the delay sat in manual routing. So I redesigned the Collibra stewardship workflows to auto-route based on domain and asset type, using the 5-role model I'd already built for GPD-IP. I added tiered review: low-risk changes to Codelists and Glossary terms got auto-approved with notifications, while Rulebook and Data Dictionary changes required human review. I also consolidated notifications into a single daily digest instead of ad-hoc email chains.\n\nWe cut cycle time from 14 to under 10 business days — a 30% reduction. Auto-approval handled 40% of routine changes, which freed up our stewards and SMEs to focus on the complex decisions. Audit compliance stayed at 100%. The Deloitte team actually referenced this workflow design at Pfizer's Data Citizens '24 presentation as an example of governance at scale.",
    },
    {
      id: "story_seed_5",
      ...
      talkTrack: "In 2024, Pfizer needed to make a definitive platform decision. We had over $2M in annual governance tooling spend split between Collibra and Alation. The R&D teams on Alation had years of institutional comfort and were skeptical about any migration. This was a politically sensitive evaluation with real budget consequences.\n\nI partnered with Divye Goel, who ran the R&D domain, and we structured the evaluation around how our teams actually worked — not feature comparison matrices from analyst reports. We tested against four criteria: data lineage depth — could the platform trace a clinical data field end-to-end? UI accessibility for non-technical business SMEs. Mass upload/download for bulk metadata operations. And total cost of ownership.\n\nI built a feature-mapping matrix showing which Alation capabilities Collibra could absorb and which would need new workflows. This made the recommendation defensible — it wasn't opinion, it was evidence grounded in our specific use cases.\n\nCollibra won on all four criteria. Deeper lineage, more intuitive UI, better bulk operations, and lower long-term TCO. Leadership accepted the recommendation. The migration was executed in 2025 with a 50% licensing cost reduction. Divye confirmed the outcomes and has offered to be a reference.",
    },
    {
      id: "story_seed_6",
